...
struct FavPlaces: View {
    ...
    @State var position = MapCameraPosition.region(
        MKCoordinateRegion(
            center: CLLocationCoordinate2D(latitude: 25.6776487, longitude: -100.2335343),
    ...
    let height = stride(from: 1.3, through: 1.3, by: 1.1).map{ PresentationDetent.fraction($0)}
